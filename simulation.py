...
if __name__ == "__main__":
    ...
    img_lowres = cv2.resize(img,(160,120))
    ...
    print("ylow",np.max(y_low),np.min(y_low))
    ...
    print(np.max(reimg))
    cv2.imwrite("./img/result/origin_image2.jpg",img_highres)
    cv2.imwrite("./img/result/recon2_"+str(cs_rate)+".jpg",reimg.astype(np.uint8))
